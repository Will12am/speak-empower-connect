...
const GallerySection = () => {
  ...
  const items = [
    { type: "video" as const, image: "https://img.youtube.com/vi/OSvaOstCE10/hqdefault.jpg", label: "Conférence — Santé mentale au travail", link: "https://www.youtube.com/watch?v=OSvaOstCE10" },
    { type: "video" as const, image: "https://img.youtube.com/vi/F0X8Y4U4W0w/hqdefault.jpg", label: "Intervention — Prévention du harcèlement", link: "https://youtu.be/F0X8Y4U4W0w" },
